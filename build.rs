...
fn main() {
    ...
    generate(Shell::Bash, &mut app, &outdir, "bash/ash");
    generate(Shell::Elvish, &mut app, &outdir, "elvish/ash");
    generate(Shell::Fish, &mut app, &outdir, "fish/ash");
    generate(Shell::PowerShell, &mut app, &outdir, "powershell/ash");
    generate(Shell::Zsh, &mut app, &outdir, "zsh/_ash");
}